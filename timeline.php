...
$rows = array(
              ...
              array("1892", "Animals' Rights: Considered in Relation to Social Progress", "Written by social reformer Henry Salt.\n An early exposition of the philosophy of animal rights.", "img/team/no-image.jpg"),
              array("1828-1898", "States Protected Laboratory Animals", "There were a number of states that passed anti-cruelty laws between 1828 and 1898. 14 states exempted animal experiments.", "img/team/no-image.jpeg"),
              ...
              array("1876", "the Cruelty to Animals Act of 1876", "The first national law to regulate animal experimentation was passed in Britain in 1876. This bill created a central governing body that reviewed and approved all animal use in research. After that, there were numerous countries in Europe that adopted some regulations regarding research with animals.", "img/team/no-image.jpeg"),
              array("1866", "The American Society for the Prevention of Cruelty to Animals is established.", "Since its inception in 1866, the organization's mission is 'to provide effective means for the prevention of cruelty to animals throughout the United States.'", "img/team/no-image.jpg"),
              ...
              array("1600-1800", "Unregulated Animal Use in Research", "Example: Galen the Physician (126- ca216) dissected animals (pigs, Barbary apes, and other animals) to gain knowledge of the functions of the kidney and spinal cord and similarities between humans and the other mammalian species that people came in contact with. \nLouis Pasteur used rabbits to find an attenuated rabies agent that he used as a vaccine against the disease anthrax and rabies. \nNo laws anywhere that governed how animals were used in research or vaccine production.","img/team/no-image.jpg"),
              array("1830s", "Early Vegan", "Early vegan and anti-vivisectionist Lewis Gompertz leaves the SPCA to found the Animals' Friend Society, opposing all uses of animals which are not for their benefit.","img/team/no-image.jpg"),
              array("1824", "First Animal Protection Organization", "Richard Martin, along with Reverend Arthur Broome and abolitionist Member of Parliament William Wilberforce, founds the Society for the Prevention of Cruelty to Animals (now the Royal Society for the Prevention of Cruelty to Animals), the world's first animal protection organization", "img/team/no-image.jpg"),
              array("1822", "British Parliament Cares About Cattle", "Led by Richard Martin, British Parliament passes the Act to Prevent the Cruel and Improper Treatment of Cattle","img/team/no-image.jpg"),
